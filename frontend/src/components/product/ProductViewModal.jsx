    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div
          ...
          className={`bg-white w-full max-w-2xl rounded-2xl p-6 relative shadow-2xl transform transition-all duration-300 ease-out ${
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-gray-500 text-sm">ราคา</label>
          ...
          <div className="mt-6 flex justify-end">
            <button onClick={onClose} className="px-6 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg font-semibold transition-colors duration-200">
              ปิด
            </button>
          </div>
        </div>
